...
function organism_list_group_sub($deptnoup,$deptname,$length,$gubun)
{
	...
	$href_forward = "<a href=".$PAGE_NSSO_URL."?deptcode=".$deptnoup."&pid=".$rPid."&pseq=".$rPseq.">";
	$href_rear = "</a>";
...
<tr> 
	...
	<!-- <td class="common-td-top2">&nbsp;&nbsp;<font color="#868038"><a href="./info_inwon_nsso.php"><b><?=$pid?>왼쪽메뉴 com_name</b></a></font></td> -->
</tr>
</table>
<?
